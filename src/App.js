...
function App() {
  ...
  return (
      <div className={`${darkMode ? "dark" : ""}`}>
        <div className={"flex relative overflow-hidden dark:text-white bg-bg-light dark:bg-bg-dark"}>
          <Navbar/>
          ...
          <div id={"about"} className={"relative w-full h-screen"}>
            ...
            <div className={"absolute top-1/2 inset-x-0 bottom-0 z-10 border-b border-black dark:border-white bg-opacity-40 bg-cyan-200 dark:bg-cyan-300 dark:bg-opacity-50 pointer-events-none"}/>
          </div>
          <div id={"xp"} className={"flex"}>
              ...
              <div className={"w-full z-20 overflow-y-scroll text-lg pl-5 mt-20"}>
