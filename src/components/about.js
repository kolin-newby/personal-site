...
export default function About() {
    ...
    return(
        <div id={"about"} className={"relative flex h-[calc(100vh-5rem)] items-center"}>
            <div className={"flex flex-row items-center h-full w-full"}>
                <div className={"flex justify-center items-start h-full w-full pt-10"}>
                    <span className={"flex w-3/4 bg-white/60 rounded-lg p-6"}>I have a passion for hiking, backpacking, and photography. Please feel free to check out some of my favorite shots by clicking on my photo in the center of the screen!
                ...
                <div className={"flex justify-center items-end h-full pb-10 w-full"}>
                   <span className={"flex w-3/4 bg-white/60 rounded-lg p-6"}>I have my BS in Computer Science from CU Boulder and I went from there to building an open source API logger written in Go,
