...
export default function About() {
    ...
    return(
        <div id={"about"} className={"flex largest:flex-row flex-col small:h-screen items-center px-20"}>
            <div className={"flex flex-col text-xl largest:text-2xl space-y-6 largest:w-1/2 pt-5"}>
                <span
                    className={"flex largest:text-6xl text-5xl mt-5 largest:mt-0 justify-center font-extrabold small:pb-20 pb-5"}
                >
            ...
            <div className={"flex largest:w-1/2 h-full"}>
                <PhotoCarousel/>
            </div>
        </div>
    )
