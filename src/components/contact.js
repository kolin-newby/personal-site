  ...
  return (
    ...
    >
      <div className={"flex flex-col items-center justify-center w-full"}>
        ...
        <span
          className={
            ...
            "from-theme-light-1 to-theme-light-2 dark:from-theme-dark-1 dark:to-theme-dark-2 text-transparent text-center"
          }
        >
      ...
      >
        ...
        <div
          className={
            "flex w-full bg-gradient-to-r from-theme-light-1 to-theme-light-2 dark:from-theme-dark-1 dark:to-theme-dark-2 rounded"
          }
        >
          <input
            id={"inputSubject"}
