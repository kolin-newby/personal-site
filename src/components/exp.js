...
export default function Experience({ darkMode }) {
  ...
  return (
    <div id={"xp"} className={"flex flex-grow min-h-screen items-center"}>
      <div
        className={
          "flex flex-col 2xl:flex-row items-center h-full 2xl:h-[50rem] w-full"
        }
      >
        <div
          className={
            "flex shrink flex-col 2xl:w-[37.5%] justify-center px-10 2xl:mb-0 mb-0"
          }
        >
          <span
            className={
              "flex 2xl:text-6xl sm:text-5xl text-4xl mt-5 2xl:mt-0 justify-center font-extrabold pb-10"
            }
          >
            {title.split("").map((letter, index) => (
              <span
                key={"exp-title-" + letter + index}
                className={
        ...
        <div className="w-[37.5%] h-5/6">
          <div
            className={
              "hidden 2xl:flex shadow-xl dark:shadow-blue-900 hover:shadow-lg rounded-lg " +
          ...
          >
            <div
              className={
                "flex items-end justify-evenly space-y-10 p-8 rounded-lg bg-bg-light " +
              ...
              {skills
                ...
                .map((skill) => (
                  ...
                  >
                    <div
                      className={
                        "flex bg-gray-200 dark:bg-gray-800/70 rounded-full items-end " +
                        "w-5 h-full"
                      }
                    >
                      <div
                    ...
                    <span
                      className={
                        "flex h-5 text-center text-xl mt-8 items-center justify-center font-bold"
                      }
                    >
                      {skill.name}
                    </span>
        ...
        <div className={"flex flex-col 2xl:w-1/4 px-6 space-y-8"}>
          ...
          >
            <div
              className={
                "flex w-96 h-max items-center justify-center 2xl:hidden box-content " +
            ...
            >
              <div
                className={
                  "flex 2xl:hidden dark:hidden relative items-center justify-center rounded " +
              ...
              <div
                className={
                  "2xl:hidden hidden dark:flex relative items-center justify-center rounded " +
                  "bg-bg-light dark:bg-bg-dark h-max w-full"
                }
              >
                <ResponsiveContainer
            ...
            <div
              className={
                "flex flex-col space-y-8 2xl:px-0 med:pl-6 items-center"
              }
            >
              <a
                href={
                  "https://www.colorado.edu/cs/academics/undergraduate-programs/bachelor-science#software_engineering-755"
                }
                target={"_blank"}
                rel={"noreferrer"}
                className={
                  "flex flex-col 2xl:h-1/3 p-5 justify-center items-center " +
              ...
              >
                ...
                <span className={"flex text-center 2xl:text-base"}>
                  A degree in Computer Science with a focus on Software
                  Development and a minor in Business
                </span>
              </a>
              <a
