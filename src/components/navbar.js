  ...
  return (
    <>
      <div className=" hidden lg:flex z-20 w-40 h-screen flex-col justify-between transition-colors bg-gradient-to-b from-theme-light-1/70 to-theme-light-2/70 dark:from-theme-dark-1 dark:to-theme-dark-2">
        <button
          className={
            "group flex flex-col items-center cursor-pointer h-max justify-center py-16 bg-black/70 dark:bg-white/70"
          }
          onClick={() => scrollTo("home")}
        >
          <span
            className={
              "text-8xl font-extrabold bg-clip-text text-transparent " +
              "bg-gradient-to-r from-theme-light-1 to-theme-light-2 " +
              "dark:from-theme-dark-1 dark:to-theme-dark-2 group-hover:animate-wiggle"
            }
          >
            K
          </span>
      ...
      <div className="z-50 flex w-full relative lg:hidden flex-col justify-between transition-colors bg-gradient-to-r from-theme-light-1/70 to-theme-light-2/70 dark:bg-bg-dark">
        <button
          ...
          className={
            "z-50 h-20 w-20 absolute top-0 left-0 bg-gradient-to-t from-theme-light-1 to-theme-light-2 dark:from-theme-dark-1 dark:to-theme-dark-2"
          }
        >
          <FontAwesomeIcon
            size={"2xl"}
            className={"bg-clip-text text-bg-dark dark:text-bg-light"}
            icon={"bars"}
          />
        </button>
        <button
          className={
            "flex z-10 relative flex-col items-center cursor-pointer h-20 justify-center bg-black dark:bg-white"
          }
          onClick={() => scrollTo("home")}
        >
          <span
            className={
              "text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-theme-light-1 to-theme-light-2 dark:from-theme-dark-1 dark:to-theme-dark-2"
            }
          >
            K
          </span>
        ...
        <Transition
          ...
          className={
            "absolute flex flex-col w-full top-20 bg-gradient-to-r from-theme-light-1 to-theme-light-2 dark:from-theme-dark-1 dark:to-theme-dark-2"
          }
        >
          <div className={"flex flex-col items-center h-max justify-center"}>
            {navbarItems.map((item) => (
              <button
                ...
                onClick={() => scrollTo(item.id)}
                className={
                  "group relative flex cursor-pointer w-32 text-xl font-bold justify-center items-center py-6"
                }
              >
                {item.title}
              </button>
          ...
          <div className={"flex flex-col justify-center items-center my-4"}>
            <div className={"flex items-center justify-between px-5 w-full"}>
              ...
              <div
                className={
                  "flex justify-center items-center space-x-3 text-bg-dark dark:text-bg-light"
                }
              >
                {mediaLinks.map((link) => (
                  <a
