  ...
  const graylogPhotos = [
    ...
    return (
        <div className={`flex h-screen w-full items-center px-10 space-x-10 ${className}`} id={"work"}>
            ...
            <div
                className={"shadow-lg flex flex-col justify-center space-y-3 p-3 basis-1/2 text-sm bg-gradient-to-br from-orange-400 via-pink-600 to-purple-400 overflow-hidden rounded-sm"}>
                <div className={"flex p-2 h-max rounded-sm bg-gray-200"}>
