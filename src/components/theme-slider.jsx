  ...
  return (
    <div className={"flex drop-shadow-lg"}>
      ...
      >
        <div
          className={
            "z-10 group transition-all rounded-lg relative h-7 w-16 bg-transparent hover:bg-white/20"
          }
        >
          <span
            className={`${
          ...
          <FontAwesomeIcon
            className={`${
              darkMode ? "text-bg-light left-1.5" : "text-bg-dark right-1.5"
            } absolute inset-y-1.5 h-4.5 w-4.5 drop-shadow`}
